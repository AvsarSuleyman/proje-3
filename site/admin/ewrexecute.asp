...
EW_SESSION_LANGUAGE_FILE_CACHE = EW_PROJECT_NAME & "_LanguageFile_pCd76cctG5CtzkN2" ' Language File Cache
Dim EW_SESSION_LANGUAGE_CACHE
EW_SESSION_LANGUAGE_CACHE = EW_PROJECT_NAME & "_Language_pCd76cctG5CtzkN2" ' Language Cache
...
Function ew_YuiHost()
	' Use files online
	If ew_IsHttps() Then
		ew_YuiHost = "https://ajax.googleapis.com/ajax/libs/yui/2.9.0/"
	Else
		ew_YuiHost = "http://yui.yahooapis.com/2.9.0/"
	End If
End Function
' Check if HTTPS
Function ew_IsHttps()
